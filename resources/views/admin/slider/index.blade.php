                        ...
                        <div class="form-layout">
                            <div class="row mg-b-25">
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <div class="checkbox_valye">
                                        <div class="input_chack">
                                            <input class="inpou" type="checkbox" name="product_color[]" value="Red">
                                        </div>
                                        <div class="name_value">
                                           <h6> Red</h6>
                                        </div>
                                        ...
                                        <div class="input_chack">
                                            <input class="inpou" type="checkbox" name="product_color[]" value="Gray">
                                        </div>
                                        <div class="name_value">
                                           <h6> Gray</h6>
                                        </div>
                                    ...
                                    <div class="checkbox_valye mt-3">
                                        <div class="input_chack">
                                            <input class="inpou" type="checkbox" name="product_color[]" value="Yellow">
                                        </div>
                                        <div class="name_value">
                                           <h6> Yellow</h6>
                                        </div>
                                        ...
                                        <div class="input_chack">
                                            <input class="inpou" type="checkbox" name="product_color[]" value="Parpule">
                                        </div>
                                        <div class="name_value">
                                           <h6> Parpule </h6>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mg-b-10-force">
                                        <label class="form-control-label"> Short Description: <span
                                                class="tx-danger">*</span></label>
                                        <textarea name="sort_description" style="width: 100%; min-height:80px"></textarea>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mg-b-10-force">
                                        <label class="form-control-label"> Long Description: <span
                                                class="tx-danger">*</span></label>
                                        <textarea name="long_description" style="width: 100%; min-height:80px"></textarea>
