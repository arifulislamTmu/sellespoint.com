                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="{{ url('cat-status-dactive/'.$category->id)}}" class="p-0 m-0" ><i style="font-size: 25px;" class="icon ion-toggle-filled"></i></a>
                                  @else
                                  <a href="{{ url('cat-status-active/'.$category->id)}}" class="p-0 m-0" ><i style="font-size: 25px;" class="icon ion-toggle"></i></a>
                                  @endif
                                </td>
                                <td>
                                  <a href="{{ route('edit.category',$category->id) }}" class="btn btn-success btn-sm"><i class="icon ion-edit"></i></a>
                                  <a href="{{ route('delete.category',$category->id) }}" class="btn btn-danger  btn-sm"><i class="icon ion-trash-b"></i></a>
                                </td>
                              </tr>
                              @endforeach
                            </tbody>
                        ...
                        <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
                          ...
                          <div class="row row-xs">
                            <label class="form-control-label py-2">Category Name</label>
                              <input type="text" name="category_name" class="form-control @error('category_name') is-invalid @enderror" placeholder="Enter Category">
                              @error('category_name')
