                            ...
                            <div class="toolbox-sort">
                                ...
                                <div class="select-custom">
                                    <select name="sortby" id="sortby" class="form-control">
                                        <option id="high_peice" value="high_peice" selected="selected">High Price</option>
                                    ...
                                    <div class="">
                                        ...
                                        <div class=" product_data d-flex justify-content-between">
                                            <div class="category_pro">
                                                <a class="text-dark category_id_click"> {{  $category->category_name  }}</a>
                        ...
                        <div class="widget widget-collapsible">
                            ...
                            <div class="collapse show" id="widget-5">
                                    ...
                                    <div class="range-input">
                                      <input type="range" id="range_price_left" class="range-min" min="0" max="2000" value="500" step="50">
                                      <input type="range" id="range_price_right" class="range-max" min="0" max="2000" value="1200" step="50">
                                    </div>
                            </div><!-- End .collapse -->
                        ...
                        <div class="widget widget-collapsible">
                            ...
                            <div class="collapse show" id="widget-4">
                                <div class="">
                                    ...
                                    <div class=" product_data d-flex justify-content-between">
                                        <div class="category_pro">
                                            <a class="text-dark brnad_id_click"> {{  $brand->brand_name  }}</a>
