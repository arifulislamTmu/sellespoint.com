                            ...
                            <h2 class="checkout-title">Order Shipping  Details</h2><!-- End .checkout-title -->
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="frist_name" value="{{ Auth::user()->name }}" required>
                                    </div><!-- End .col-sm-6 -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="division"  value="{{ Auth::user()->division }}" required>
                                    </div><!-- End .col-sm-6 -->
                                </div><!-- End .row -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Thana *</label>
                                        <input type="text" class="form-control" name="thana"   value="{{ Auth::user()->thana }}" required>
                                    </div><!-- End .col-sm-6 -->
                                </div><!-- End .row -->
                                <label>Address/Holdding no * </label>
                                <textarea class="form-control" cols="30" name="address_holdding" rows="4">
                                    {{ Auth::user()->address_holdding }}
                                </textarea>
                      </div><!-- End .col-lg-9 -->
